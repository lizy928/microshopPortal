    ...
    <section id="pc-banner">
      <div class="yBanner">
        <div class="banner" id="banner" >
          ...
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner3.jpg) center no-repeat;background-color: #081f3c; padding-left:180px;"></a>
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner4.jpg) center no-repeat;background-color: #4684ff; padding-left:180px;"></a>
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner5.jpg) center no-repeat;background-color: #a89d9f; padding-left:180px;"></a>
...
export default {
  ...
  methods:{
    ...
    getIndexItem(){
      let activityIni = this
      let requestUrl = request.request.REQUEST + '/portal/getIndexItem'
      // 加载table的数据
      axios({
        method: 'get',
        url: requestUrl,
