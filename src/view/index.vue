<template>
  <div>
    <div>
      ...
      <div id="moquu_wshare" class="moquu_wshare"><a href="javascript:void(0)" style="text-indent:0"><div class="moquu_wshareh"><img src="/static/icon/moquu_wshare.png" width="100%"></div></a></div>
    ...
    <header id="pc-header">
      <div class="BHeader">
        <div class="yNavIndex">
          <ul class="BHeaderl">
            ...
            <li><a href="login.vue" style="color:#ea4949;">请登录</a> </li>
            ...
            <li id="pc-nav1" class="menu"><a href="#" class="tit M-iphone">手机悦商城</a>
              <div class="subnav">
                <a href="#"><img src="/static/icon/ewm.png" width="115" height="115" title="扫一扫，有惊喜！"></a>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="container clearfix">
        <div class="header-logo fl"><h1><a href="首页.html"><img src="/static/icon/logo.png"></a> </h1></div>
        ...
        <div class="header-cart fr"><a href="#"><img src="/static/icon/car.png"></a> <i class="head-amount">99</i></div>
        ...
        <div class="yNavIndex">
          <div class="pullDown">
            ...
            <ul class="pullDownList">
              <li class="menulihover" v-for="(item,index) in menuList" @mouseover="showParentMenu(index)" :class="{'active':ind == index}" v-bind:style="selectedBg">
                <i class="listi1"></i>
                <a href="all-cl.html" target="_blank">{{item.name}}</a>
                <span></span>
              </li>
            </ul>
            ...
            <div class="yMenuListCon">
              <div class="yMenuListConin">
                <div class="yMenuLCinLisi fl">
                  <ul>
                    <li v-for="item in parentMenu">
                      <a href="#">{{item.name}}<i class="fr">></i></a>
                    </li>
                  </ul>
                </div>
                <div class="yMenuLCinList fl">
                  <p v-for="item in parentMenu.item">
                    <a href="" class="ecolor610">{{item.name}}</a>
                  </p>
                </div>
              </div>
    ...
    <section id="pc-banner">
      <div class="yBanner">
        <div class="banner" id="banner" >
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner1.jpg) center no-repeat;background-color: #f01a38; padding-left:180px;"></a>
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner2.jpg) center no-repeat;background-color: #a96ae3; padding-left:180px;"></a>
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner1.jpg) center no-repeat;background-color: #081f3c; padding-left:180px;"></a>
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner1.jpg) center no-repeat;background-color: #4684ff; padding-left:180px;"></a>
          <a href="javascript:;" class="d1" style="background:url(/static/img/ad/banner2.jpg) center no-repeat;background-color: #a89d9f; padding-left:180px;"></a>
    ...
    <section id="pc-advert">
      <div class="container-c clearfix">
        <a href="page.html" target="_blank"><img src="/static/img/pd/pd1.png"></a>
        <a href="page.html" target="_blank"><img src="/static/img/pd/pd2.png"></a>
        <a href="page.html" target="_blank"><img src="/static/img/pd/pd3.png"></a>
        <a href="page.html" target="_blank"><img src="/static/img/pd/pd4.png"></a>
      </div>
    </section>
    <!-- advert End -->
    ...
    <div class="time-lists clearfix">
      ...
      <div class="news-list fr">
        ...
        <div class="time-border" style="border-left:none;">
          ...
          <div class="time-poduse"><img src="/static/img/pd/pj1.png"></div>
        </div>
      </div>
    </div>
    <!-- 限时抢购 End -->
    ...
    <div class="container-c time-lists clearfix">
      <div class="time-list fl">
        ...
        <div class="time-poued clearfix">
          <a href="#"><img src="/static/img/ad/a2.png"></a>
          <a href="#"><img src="/static/img/ad/a3.png"></a>
          <a href="#"><img src="/static/img/ad/a4.png"></a>
          <a href="#"><img src="/static/img/ad/a5.png"></a>
        </div>
      </div>
      <div class="news-list fr">
        <div class="time-title time-clear"><h2>今日值得购买</h2></div>
        <div class="news-right"><a href="#"><img src="/static/img/ad/a1.png"></a></div>
      </div>
    </div>
    <!-- 卖场推荐 End -->
    ...
    <div class="containers main-banner"><a href="#"><img src="/static/img/ad/br1.jpg" width="1200" height="105"></a> </div>
      ...
      <div class="time-list time-list-w fl">
        ...
        <div class="time-border time-border-h clearfix">
          <div class="brand-img fl">
            <ul>
              <li><a href="#"><img src="/static/img/ad/p1.png" width="125" height="47"></a></li>
              <li><a href="#"><img src="/static/img/ad/p2.png" width="125" height="47"></a></li>
              <li><a href="#"><img src="/static/img/ad/p3.png" width="125" height="47"></a></li>
              <li><a href="#"><img src="/static/img/ad/p4.png" width="125" height="47"></a></li>
              <li><a href="#"><img src="/static/img/ad/p5.png" width="125" height="47"></a></li>
              <li><a href="#"><img src="/static/img/ad/p6.png" width="125" height="47"></a></li>
            </ul>
          </div>
          <div class="brand-bar fl"><a href="#"><img src="/static/img/ad/bar.jpg" width="300" height="476"></a> </div>
          <div class="brand-poa fl">
            <div class="brand-poa H-over clearfix">
              <ul>
                <li>
                  <div class="brand-imgss"><a href="#"><img src="/static/img/pd/bar1.png"></a></div>
                  <div class="brand-title"><a href="#">罗莱家纺 暖融二合一羊毛蚕丝被 床上用品一羊毛蚕丝被一羊毛蚕丝被一羊毛蚕丝被一羊毛蚕丝被一羊毛蚕丝被</a> </div>
                  <div class="brand-price">￥599.00 </div>
                </li>
                <li>
                  <div class="brand-imgss"><a href="#"><img src="/static/img/pd/bar2.png"></a></div>
                  <div class="brand-title"><a href="#">罗莱家纺 暖融二合一羊毛蚕丝被 床上用品</a> </div>
                  <div class="brand-price">￥599.00 </div>
                </li>
                <li>
                  <div class="brand-imgss"><a href="#"><img src="/static/img/pd/bar3.png"></a></div>
                  <div class="brand-title"><a href="#">罗莱家纺 暖融二合一羊毛蚕丝被 床上用品</a> </div>
                  <div class="brand-price">￥599.00 </div>
                </li>
                <li>
                  <div class="brand-imgss"><a href="#"><img src="/static/img/pd/bar4.png"></a></div>
                  <div class="brand-title"><a href="#">罗莱家纺 暖融二合一羊毛蚕丝被 床上用品</a> </div>
                  <div class="brand-price">￥599.00 </div>
                </li>
                <li>
                  <div class="brand-imgss"><a href="#"><img src="/static/img/pd/bar5.png"></a></div>
                  <div class="brand-title"><a href="#">罗莱家纺 暖融二合一羊毛蚕丝被 床上用品</a> </div>
                  <div class="brand-price">￥599.00 </div>
                </li>
                <li>
    ...
    <div class="time-lists  clearfix">
      <div class="time-list time-list-w fl">
        ...
        <div class="time-border time-border-h clearfix">
          ...
          <div class="brand-bar fl"><a href="#"><img src="/static/img/ad/bar1.jpg" width="300" height="476"></a> </div>
          <div class="brand-poa fl">
    ...
    <div class="time-lists clearfix">
      <div class="time-list fl">
        ...
        <div class="time-border time-border-h clearfix">
          <div class="fl shop-img">
            <div class="shop-title"><a href="#"><img src="/static/img/ad/shop1.png"></a></div>
            <div class="shop-text"><h2>熊太子坚果炒货金冠店铺...</h2> <p>[正品 有赠品 如实描述]</p></div>
            <div class="shop-work clearfix"><a href="#"><img src="/static/img/ad/shop2.png"></a><a href="#"><img src="/static/img/ad/shop3.png"></a> </div>
          </div>
          <div class="shop-bar clearfix fl">
            <ul>
              <li>
                <div class="shop-icn"><a href="#"><img src="/static/img/ad/shop4.png"></a></div>
      ...
      <div class="news-list fr">
        ...
        <div style="border-left:none;" class="time-border time-border-h">
          <ul class="shop-top">
            <li class="clearfix">
              <div class="shop-name fl"><a href="#"><img src="/static/img/ad/top1.png"></a></div>
        ...
        <div class="time-list time-list-w fl">
          ...
          <div class="time-border time-border-h clearfix">
            <div class="fl shop-img">
              ...
              <div class="shop-re"><a href="#"><img src="/static/img/ad/shop5.png"></a> </div>
            </div>
            <div class="shop-bar shop-bar-w clearfix fl">
              ...
              <div class="clearfix" style="width:980px;">
                <div class="shop-fl fl">
                  <div class="shop-work clearfix"><a href="#"><img src="/static/img/ad/shop2.png"></a><a href="#"><img src="/static/img/ad/shop3.png"></a> </div>
                  <div class="clearfix"><div class="shop-name fl"><a href="#"><img src="/static/icon/shop-user.png"></a></div><div class=" fl"><p>搜悦用户</p> <p>2015-5-24 <em>11:25</em></p> </div></div>
    ...
    <div class="aui-footer-bot">
      <div class="time-lists aui-footer-pd clearfix">
        <div class="aui-footer-list clearfix">
          <h4>
            <span><img src="/static/icon/icon-d1.png"></span>
            <em>消费者权益</em>
          </h4>
          <ul>
            <li><a href="#">保障范围 </a> </li>
        ...
        <div class="aui-footer-list clearfix">
          <h4>
            <span><img src="/static/icon/icon-d2.png"></span>
            <em>新手上路</em>
          </h4>
          <ul>
            <li><a href="#">退货退款流程</a> </li>
        ...
        <div class="aui-footer-list clearfix">
          <h4>
            <span><img src="/static/icon/icon-d3.png"></span>
            <em>保障正品</em>
          </h4>
          <ul>
            <li><a href="#">退货退款流程</a> </li>
...
import {banner} from '../../static/js/top.js'
...
export default {
  ...
  methods:{
    ...
    initMenuList(){
      let that = this;
      let requestUrl = request.request.REQUEST + '/portal/getSortMenuList'
      // 加载table的数据
      axios({
        method: 'post',
        url: requestUrl,
    ...
    showParentMenu(index){
      let that = this;
      that.ind = index;
      that.parentMenu = that.menuList[index]
    },
